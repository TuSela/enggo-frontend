...
class PvpResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ── My stats ─────────────────────────────────────────────────────────
        findViewById<TextView>(R.id.tv_my_score).text =
            "${myResult.playerScore} điểm"
        findViewById<TextView>(R.id.tv_my_correct).text =
            "${myResult.correctAnswersCount ?: 0} câu đúng"
        ...
        // ── Opponent stats ────────────────────────────────────────────────────
        findViewById<TextView>(R.id.tv_opp_score).text =
            "${oppResult.playerScore} điểm"
        findViewById<TextView>(R.id.tv_opp_correct).text =
            "${oppResult.correctAnswersCount ?: 0} câu đúng"
        ...
        findViewById<Button>(R.id.btn_play_again).setOnClickListener {
            startActivity(Intent(this, PvpActivity::class.java).apply {
